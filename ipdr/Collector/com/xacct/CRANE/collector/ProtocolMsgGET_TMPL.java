...
// $Id: ProtocolMsgGET_TMPL.java,v 1.4 2005/01/30 15:13:41 ilyad Exp $
//Copyright (2005) (c) Amdocs, All Rights Reserved
//This software is distributed on an "AS IS" basis, WITHOUT WARRANTY OF 
//ANY KIND either expresses or implied.

/** The Java encapsulation of a CRANE protocol messages: "GET_TMPL".
 *  <xmp>
 *        0                   1                   2                   3
 ...
 *  </xmp>
 *
 *  @version $Id: ProtocolMsgGET_TMPL.java,v 1.4 2005/01/30 15:13:41 ilyad Exp $
 */
public final class ProtocolMsgGET_TMPL extends ProtocolMsg
{
    /** $Id: ProtocolMsgGET_TMPL.java,v 1.4 2005/01/30 15:13:41 ilyad Exp $ */
    public static String versionStr() { return "@(#) $Id: ProtocolMsgGET_TMPL.java,v 1.4 2005/01/30 15:13:41 ilyad Exp $"; }

    public String msgName() { return "GET_TMPL"; }
     ...
     */
    public ProtocolMsgGET_TMPL(byte [] msg, int length) throws ProtocolMalformedMsgException {
