...
// $Id: ProtocolMsgKeyBlock.java,v 1.4 2005/01/30 15:13:41 ilyad Exp $
 ...
 *  </xmp>
 *
 *  @version $Id: ProtocolMsgKeyBlock.java,v 1.4 2005/01/30 15:13:41 ilyad Exp $
 */
public final class ProtocolMsgKeyBlock implements ProtocolMsgKeyBlockHandler
{
    /** $Id: ProtocolMsgKeyBlock.java,v 1.4 2005/01/30 15:13:41 ilyad Exp $ */
    public static String versionStr() { return "@(#) $Id: ProtocolMsgKeyBlock.java,v 1.4 2005/01/30 15:13:41 ilyad Exp $"; }
    ...
    public int getFromRaw(byte [] msg, int offset, FieldConfig field) {
        ...
        field.setWithoutFieldDesc(keyId, keyTypeId, null, null, enabled);
