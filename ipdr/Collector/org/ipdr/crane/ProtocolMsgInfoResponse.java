...
// $Id: ProtocolMsgInfoResponse.java,v 1.4 2005/01/30 15:13:45 ilyad Exp $
 ...
 *
 *  @version $Id: ProtocolMsgInfoResponse.java,v 1.4 2005/01/30 15:13:45 ilyad Exp $
 */
public final class ProtocolMsgInfoResponse implements ProtocolMsgIdentification
{
    /** $Id: ProtocolMsgInfoResponse.java,v 1.4 2005/01/30 15:13:45 ilyad Exp $ */
    public static String versionStr() { return "@(#) $Id: ProtocolMsgInfoResponse.java,v 1.4 2005/01/30 15:13:45 ilyad Exp $"; }

    /// The message type's name
    public String msgName() { return "ProtocolInfoResponse"; }

    /// The information block(s)
    public ProtocolInfoBlock [] info;
