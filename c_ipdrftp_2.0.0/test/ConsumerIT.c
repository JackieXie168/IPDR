...
int main()
{
	...
	char docName[100] = "/home/vishal/ipdrftp/test/Voip/document-";
	char outDir[100] = "c:/share/Voip/"; /*directory where .csv will be generated*/
...
//Test 5.1.1.1
	...
	*/
	//capabilityFile = readCapabilityFile(errorList ,"file://192.168.122.152/home/vishal/ipdrftp/test/Capability.xml");
...
//Reading control files from URI
	...
	while(isEnd(errorList,ctrlFile)!=1){
		...
		{
			if(strlen(docName)!=0)
				testReadFTP(1,docName,"c:/share/voip/");
			puts(docName);
		}
	}
