...
rm -Rf autom4te.cache m4 'm4'$'\r'
# Remove rest of the generated files.
rm -f Makefile.in aclocal.m4 compile configure config.status depcomp install-sh missing ltmain.sh libtool .built .configured configure.scan .prepared .version* *~ test-driver stamp-h.in
