...
// $Id: ProtocolMsgERROR.java,v 1.4 2005/01/30 15:13:39 ilyad Exp $
 ...
 *  </xmp>
 *
 *  @version $Id: ProtocolMsgERROR.java,v 1.4 2005/01/30 15:13:39 ilyad Exp $
 */
public final class ProtocolMsgERROR extends ProtocolMsg
{
    /** $Id: ProtocolMsgERROR.java,v 1.4 2005/01/30 15:13:39 ilyad Exp $ */
    public static String versionStr() { return "@(#) $Id: ProtocolMsgERROR.java,v 1.4 2005/01/30 15:13:39 ilyad Exp $"; }
    ...
    public String toString() {
        return super.toString() +
            "[timestamp=" + CollectorUtil.dateFormat(timestamp) +
            " errCode=" + errorCode +
            " descr: " + description +
            "]";
    }
