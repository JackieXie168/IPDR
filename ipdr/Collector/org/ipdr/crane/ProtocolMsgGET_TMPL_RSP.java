...
// $Id: ProtocolMsgGET_TMPL_RSP.java,v 1.4 2005/04/08 12:48:14 guyg Exp $
 ...
 *
 *  @version $Id: ProtocolMsgGET_TMPL_RSP.java,v 1.4 2005/04/08 12:48:14 guyg Exp $
 */
public final class ProtocolMsgGET_TMPL_RSP extends ProtocolMsg
{
    /** $Id: ProtocolMsgGET_TMPL_RSP.java,v 1.4 2005/04/08 12:48:14 guyg Exp $ */
    public static String versionStr() { return "@(#) $Id: ProtocolMsgGET_TMPL_RSP.java,v 1.4 2005/04/08 12:48:14 guyg Exp $"; }
     ...
     */
   public ProtocolMsgGET_TMPL_RSP(byte [] msg, int length)
            ...
            this.templateBlock =
                new ProtocolMsgTemplateBlock(msg, TEMPLATES_OFFSET,
                                             bigE.getUnsignedShort(msg, NUMBER_TEMPLATES_OFFSET),
                                                        new ProtocolMsgExtendedKeyBlock());
