...
// $Id: ProtocolMsgExtendedKeyBlock.java,v 1.4 2005/01/30 15:13:42 ilyad Exp $
 ...
 *  </xmp>
 *
 *  @version $Id: ProtocolMsgExtendedKeyBlock.java,v 1.4 2005/01/30 15:13:42 ilyad Exp $
 */
public final class ProtocolMsgExtendedKeyBlock implements ProtocolMsgKeyBlockHandler
{
    /** $Id: ProtocolMsgExtendedKeyBlock.java,v 1.4 2005/01/30 15:13:42 ilyad Exp $ */
    public static String versionStr() { return "@(#) $Id: ProtocolMsgExtendedKeyBlock.java,v 1.4 2005/01/30 15:13:42 ilyad Exp $"; }
    ...
    public int getFromRaw(byte [] msg, int offset, FieldConfig field) {
        ...
        field.setWithoutFieldDesc(keyId, keyTypeId, keyLabel, keyHelp, enabled);
